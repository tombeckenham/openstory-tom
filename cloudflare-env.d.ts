/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 40033b4940d2cc505f7ebed81e261313)
...
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    ...
    IMAGE_WORKFLOW: Workflow<
      Parameters<import('./src/server').ImageWorkflow['run']>[0]['payload']
    >;
    ELEMENT_VISION_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').ElementVisionWorkflow['run']
      >[0]['payload']
    >;
    MUSIC_WORKFLOW: Workflow<
      Parameters<import('./src/server').MusicWorkflow['run']>[0]['payload']
    >;
    MOTION_WORKFLOW: Workflow<
      Parameters<import('./src/server').MotionWorkflow['run']>[0]['payload']
    >;
    MOTION_BATCH_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').MotionBatchWorkflow['run']
      >[0]['payload']
    >;
    CHARACTER_SHEET_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').CharacterSheetWorkflow['run']
      >[0]['payload']
    >;
    LOCATION_SHEET_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').LocationSheetWorkflow['run']
      >[0]['payload']
    >;
    LIBRARY_TALENT_SHEET_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').LibraryTalentSheetWorkflow['run']
      >[0]['payload']
    >;
    LIBRARY_LOCATION_SHEET_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').LibraryLocationSheetWorkflow['run']
      >[0]['payload']
    >;
    SHOT_VARIANT_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').ShotVariantWorkflow['run']
      >[0]['payload']
    >;
    UPSCALE_SHOT_VARIANT_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').UpscaleShotVariantWorkflow['run']
      >[0]['payload']
    >;
    VISUAL_PROMPT_SCENE_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').VisualPromptSceneWorkflow['run']
      >[0]['payload']
    >;
    MOTION_PROMPT_SCENE_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').MotionPromptSceneWorkflow['run']
      >[0]['payload']
    >;
    MUSIC_PROMPT_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').MusicPromptWorkflow['run']
      >[0]['payload']
    >;
    RECAST_CHARACTER_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').RecastCharacterWorkflow['run']
      >[0]['payload']
    >;
    LOCATION_MATCHING_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').LocationMatchingWorkflow['run']
      >[0]['payload']
    >;
    FRAME_IMAGES_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').FrameImagesWorkflow['run']
      >[0]['payload']
    >;
    TALENT_MATCHING_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').TalentMatchingWorkflow['run']
      >[0]['payload']
    >;
    CHARACTER_BIBLE_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').CharacterBibleWorkflow['run']
      >[0]['payload']
    >;
    LOCATION_BIBLE_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').LocationBibleWorkflow['run']
      >[0]['payload']
    >;
    VISUAL_PROMPT_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').VisualPromptWorkflow['run']
      >[0]['payload']
    >;
    MOTION_PROMPT_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').MotionPromptWorkflow['run']
      >[0]['payload']
    >;
    MOTION_MUSIC_PROMPTS_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').MotionMusicPromptsWorkflow['run']
      >[0]['payload']
    >;
    REGENERATE_FRAMES_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').RegenerateFramesWorkflow['run']
      >[0]['payload']
    >;
    RECAST_LOCATION_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').RecastLocationWorkflow['run']
      >[0]['payload']
    >;
    REPLACE_ELEMENT_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').ReplaceElementWorkflow['run']
      >[0]['payload']
    >;
    SCENE_SPLIT_WORKFLOW: Workflow<
      Parameters<import('./src/server').SceneSplitWorkflow['run']>[0]['payload']
    >;
    STORYBOARD_WORKFLOW: Workflow<
      Parameters<import('./src/server').StoryboardWorkflow['run']>[0]['payload']
    >;
    ANALYZE_SCRIPT_WORKFLOW: Workflow<
      Parameters<
        import('./src/server').AnalyzeScriptWorkflow['run']
      >[0]['payload']
    >;
  }
  interface TestEnv {
